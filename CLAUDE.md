# KayaFlow — Claude Code Instructions
...
- **AI**: Anthropic Claude API (claude-sonnet-4-6 default, claude-haiku-4-5-20251001 for quick responses)
...
| `core/ux_critique_engine.py` | Main Claude call for UX analysis |
